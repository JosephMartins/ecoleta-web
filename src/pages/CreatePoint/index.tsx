...
interface IBGEUFResopnse{
  sigla: string;
}

interface IBGECityResopnse{
  nome: string;
}
...
const CreatePoint = () => {
  ...
  useEffect(() => {
    axios.get<IBGEUFResopnse[]>('https://servicodados.ibge.gov.br/api/v1/localidades/estados').then(response => {
